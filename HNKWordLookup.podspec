#
#  Be sure to run `pod spec lint HNKWordLookup.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "H Kellaway"
  # s.authors            = { "H Kellaway" => "hkellaway.tech@gmail.com" }
  # s.social_media_url   = "http://twitter.com/H Kellaway"
